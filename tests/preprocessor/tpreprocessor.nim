...
""", [
   ...
   new_inumber(TkIntLit, loc(-1, 2, 0), ni(7), Base10, -1, "7"),
   new_identifier(TkColon, loc(-1, 3, 0), ":"),
   new_inumber(TkIntLit, loc(-1, 4, 0), ni(0), Base10, -1, "0"),
...
""", [
   new_identifier(TkWire, loc(-1, 0, 0), "wire"),
   new_token(TkLbracket, loc(-1, 1, 0)),
   new_inumber(TkIntLit, loc(-2, 0, 0), ni(7), Base10, -1, "7"),
   new_identifier(TkColon, loc(-1, 3, 0), ":"),
   new_inumber(TkIntLit, loc(-1, 4, 0), ni(0), Base10, -1,  "0"),
   new_token(TkRbracket, loc(-1, 5, 0)),
   new_identifier(TkSymbol, loc(1, 3, 6), "my_wire"),
...
""", [
   ...
   new_inumber(TkIntLit, loc(-2, 2, 0), ni(1), Base10, -1, "1"),
   new_identifier(TkColon, loc(-2, 3, 0), ":"),
   new_inumber(TkIntLit, loc(-2, 4, 0), ni(0), Base10, -1,  "0"),
...
""", [
   ...
   new_inumber(TkUIntLit, loc(-1, 8, 0), ni(0), Base2, 1, "0"),
   new_token(TkRbrace, loc(-1, 9, 0)),
   new_token(TkRbrace, loc(-1, 10, 0)),
   new_token(TkLparen, loc(1, 2, 21)),
   new_inumber(TkIntLit, loc(1, 2, 22), ni(8), Base10, -1, "8"),
...
""", [
   ...
   new_inumber(TkIntLit, loc(1, 3, 31), ni(8), Base10, -1, "8"),
...
""", [
   ...
   new_inumber(TkIntLit, loc(1, 2, 5), ni(1), Base10, -1, "1"),
   new_identifier(TkColon, loc(1, 2, 6), ":"),
   new_inumber(TkIntLit, loc(-1, 0, 0), ni(8), Base10, -1, "8"),
   ...
   new_inumber(TkIntLit, loc(-2, 2, 0), ni(2), Base10, -1, "2"),
   ...
   new_inumber(TkIntLit, loc(-3, 2, 0), ni(5), Base10, -1, "5"),
...
"""): [
   ...
   new_inumber(TkIntLit, loc(2, 1, 6), ni(7), Base10, -1, "7"),
   new_identifier(TkColon, loc(2, 1, 7), ":"),
   new_inumber(TkIntLit, loc(2, 1, 8), ni(0), Base10, -1, "0"),
   ...
   new_inumber(TkIntLit, loc(1, 2, 6), ni(3), Base10, -1, "3"),
   new_identifier(TkColon, loc(1, 2, 7), ":"),
   new_inumber(TkIntLit, loc(1, 2, 8), ni(0), Base10, -1, "0"),
...
""", [
   ...
   new_inumber(TkIntLit, loc(1, 2, 13), ni(1), Base10, -1, "1"),
   new_identifier(TkColon, loc(1, 2, 14), ":"),
   new_inumber(TkIntLit, loc(1, 2, 15), ni(0), Base10, -1, "0"),
   new_token(TkRbracket, loc(1, 2, 16)),
...
""", [
   new_identifier(TkReg, loc(-1, 0, 0), "reg"),
   new_token(TkLbracket, loc(-1, 1, 0)),
   new_inumber(TkIntLit, loc(-1, 2, 0), ni(3), Base10, -1, "3"),
   new_identifier(TkColon, loc(-1, 3, 0), ":"),
   new_inumber(TkIntLit, loc(-1, 4, 0), ni(0), Base10, -1, "0"),
   new_token(TkRbracket, loc(-1, 5, 0)),
...
""", [
   ...
   new_token(TkLparen, loc(-1, 0, 0)),
   new_inumber(TkUIntLit, loc(-1, 1, 0), ni(1), Base2, 1, "1"),
   new_identifier(TkOperator, loc(-1, 2, 0), "&"),
   new_inumber(TkUIntLit, loc(-1, 3, 0), ni(0), Base2, 1, "0"),
