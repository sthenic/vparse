   ...
   (
      port: new_node(NkPortDecl, li(5, 4), @[
         ...
         new_node(NkRange, li(5, 15), @[
            new_inumber_node(NkIntLit, li(5, 16), ni(7), "7", Base10, -1),
            new_inumber_node(NkIntLit, li(5, 18), ni(0), "0", Base10, -1)
         ]),
   ...
   (
      port: new_node(NkPortDecl, li(7, 4), @[
         ...
         new_node(NkRange, li(7, 15), @[
            new_inumber_node(NkIntLit, li(7, 16), ni(7), "7", Base10, -1),
            new_inumber_node(NkIntLit, li(7, 18), ni(0), "0", Base10, -1)
         ]),
   ...
   (
      parameter: new_node(NkParameterDecl, li(2, 4), @[
         new_node(NkParamAssignment, li(2, 14), @[
            ...
            new_inumber_node(NkIntLit, li(2, 22), ni(32), "32", Base10, -1)
         ])
      ]),
   ...
   (
      parameter: new_node(NkParameterDecl, li(3, 4), @[
         new_node(NkParamAssignment, li(3, 14), @[
            ...
            new_inumber_node(NkIntLit, li(3, 21), ni(0), "0", Base10, -1)
         ])
      ]),
   ...
   (
      parameter: new_node(NkParameterDecl, li(2, 4), @[
         new_node(NkParamAssignment, li(2, 14), @[
            ...
            new_inumber_node(NkIntLit, li(2, 20), ni(3), "3", Base10, -1)
         ])
      ]),
...
""", @[
   ...
   (
      driver: new_node(NkContinuousAssignment, li(6, 4), @[
         new_node(NkAssignment, li(6, 11), @[
            ...
            new_inumber_node(NkIntLit, li(6, 26), ni(0), "0", Base10, -1)
         ])
      ]),
   ...
   (
      driver: new_node(NkNonblockingAssignment, li(10, 7), @[
         ...
         new_inumber_node(NkIntLit, li(10, 15), ni(0), "0", Base10, -1)
      ]),
   ...
   (
      driver: new_node(NkBlockingAssignment, li(11, 7), @[
         ...
         new_inumber_node(NkIntLit, li(11, 14), ni(1), "1", Base10, -1)
      ]),
