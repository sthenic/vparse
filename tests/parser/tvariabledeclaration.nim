...
"""):
   new_node(NkRegDecl, li(1, 1), @[
      new_node(NkRange, li(1, 5), @[
         new_inumber_node(NkIntLit, li(1, 6), ni(7), "7", Base10, -1),
   ...
   new_node(NkRegDecl, li(1, 1), @[
      ...
      new_node(NkRange, li(1, 12), @[
         new_node(NkInfix, li(1, 17), @[
            ...
            new_inumber_node(NkIntLit, li(1, 18), ni(1), "1", Base10, -1)
         ]),
         new_inumber_node(NkIntLit, li(1, 20), ni(0), "0", Base10, -1)
      ]),
...
"""):
   new_node(NkRegDecl, li(1, 1), @[
      new_node(NkAssignment, li(1, 5), @[
         ...
         new_inumber_node(NkUIntLit, li(1, 20), ni(0), "0", Base2, 1)
      ]),
   ])
   ...
   new_node(NkRegDecl, li(1, 1), @[
      new_node(NkArrayIdentifer, li(1, 5), @[
         ...
         new_node(NkRange, li(1, 15), @[
            new_inumber_node(NkIntLit, li(1, 16), ni(2), "2", Base10, -1),
...
run_test("Integer declaration, assignment", "integer foo = 8 + 8;"):
   new_node(NkIntegerDecl, li(1, 1), @[
      new_node(NkAssignment, li(1, 9), @[
         ...
         new_node(NkInfix, li(1, 17), @[
            new_identifier_node(NkIdentifier, li(1, 17), "+"),
            new_inumber_node(NkIntLit, li(1, 15), ni(8), "8", Base10, -1),
            new_inumber_node(NkIntLit, li(1, 19), ni(8), "8", Base10, -1)
         ])
      ])
   ])
   ...
   new_node(NkIntegerDecl, li(1, 1), @[
      new_node(NkArrayIdentifer, li(1, 9), @[
         ...
         new_node(NkRange, li(1, 17), @[
            new_inumber_node(NkIntLit, li(1, 18), ni(7), "7", Base10, -1),
            new_inumber_node(NkIntLit, li(1, 20), ni(0), "0", Base10, -1)
         ])
      ])
   ])
   ...
   new_node(NkIntegerDecl, li(1, 1), @[
      ...
      new_node(NkArrayIdentifer, li(1, 16), @[
         ...
         new_node(NkRange, li(1, 22), @[
            ...
            new_inumber_node(NkIntLit, li(1, 25), ni(0), "0", Base10, -1)
         ])
      ])
   ])
   ...
   new_node(NkRealDecl, li(1, 1), @[
      new_node(NkAssignment, li(1, 6), @[
         ...
         new_node(NkInfix, li(1, 14), @[
            ...
            new_inumber_node(NkIntLit, li(1, 12), ni(8), "8", Base10, -1),
            new_inumber_node(NkIntLit, li(1, 16), ni(8), "8", Base10, -1)
         ])
      ])
   ])
   ...
   new_node(NkRealDecl, li(1, 1), @[
      new_node(NkArrayIdentifer, li(1, 6), @[
         ...
         new_node(NkRange, li(1, 14), @[
            new_inumber_node(NkIntLit, li(1, 15), ni(7), "7", Base10, -1),
            new_inumber_node(NkIntLit, li(1, 17), ni(0), "0", Base10, -1)
         ])
      ])
   ])
   ...
   new_node(NkRealDecl, li(1, 1), @[
      ...
      new_node(NkArrayIdentifer, li(1, 13), @[
         ...
         new_node(NkRange, li(1, 19), @[
            ...
            new_inumber_node(NkIntLit, li(1, 22), ni(0), "0", Base10, -1)
         ])
      ])
   ])
   ...
   new_node(NkRealtimeDecl, li(1, 1), @[
      new_node(NkAssignment, li(1, 10), @[
         ...
         new_node(NkInfix, li(1, 18), @[
            ...
            new_inumber_node(NkIntLit, li(1, 16), ni(8), "8", Base10, -1),
            new_inumber_node(NkIntLit, li(1, 20), ni(8), "8", Base10, -1)
         ])
      ])
   ])
   ...
   new_node(NkRealtimeDecl, li(1, 1), @[
      new_node(NkArrayIdentifer, li(1, 10), @[
         ...
         new_node(NkRange, li(1, 18), @[
            new_inumber_node(NkIntLit, li(1, 19), ni(7), "7", Base10, -1),
            new_inumber_node(NkIntLit, li(1, 21), ni(0), "0", Base10, -1)
         ])
      ])
   ])
...
run_test("Realtime declaration, hybrid", "realtime i = 0, j[7:0][3:0];"):
   new_node(NkRealtimeDecl, li(1, 1), @[
      new_node(NkAssignment, li(1, 10), @[
         ...
         new_inumber_node(NkIntLit, li(1, 14), ni(0), "0", Base10, -1),
      ]),
      new_node(NkArrayIdentifer, li(1, 17), @[
         ...
         new_node(NkRange, li(1, 23), @[
            new_inumber_node(NkIntLit, li(1, 24), ni(3), "3", Base10, -1),
            new_inumber_node(NkIntLit, li(1, 26), ni(0), "0", Base10, -1)
         ])
      ])
   ])
