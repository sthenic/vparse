   ...
   new_node(NkListOfPortDeclarations, li(1, 1), @[
      new_node(NkPortDecl, li(2, 4), @[
         ...
         new_node(NkRange, li(2, 10), @[
            new_node(NkInfix, li(2, 15), @[
               ...
               new_inumber_node(NkIntLit, li(2, 16), 1, "1", Base10, -1)
            ]),
            new_inumber_node(NkIntLit, li(2, 18), 0, "0", Base10, -1)
         ]),
      ...
      new_node(NkPortDecl, li(4, 4), @[
         ...
         new_node(NkRange, li(4, 11), @[
            new_inumber_node(NkIntLit, li(4, 12), 0, "0", Base10, -1),
            new_inumber_node(NkIntLit, li(4, 14), 0, "0", Base10, -1)
         ]),
      ...
      new_node(NkPortDecl, li(5, 4), @[
         ...
         new_node(NkRange, li(5, 15), @[
            new_node(NkInfix, li(5, 20), @[
               ...
               new_inumber_node(NkIntLit, li(5, 21), 1, "1", Base10, -1)
            ]),
            new_inumber_node(NkIntLit, li(5, 23), 0, "0", Base10, -1)
         ]),
      ...
      new_node(NkPortDecl, li(6, 4), @[
         ...
         new_node(NkRange, li(6, 15), @[
            new_inumber_node(NkIntLit, li(6, 16), 7, "7", Base10, -1),
            new_inumber_node(NkIntLit, li(6, 18), 0, "0", Base10, -1)
         ]),
      ...
      new_node(NkPortDecl, li(7, 4), @[
         ...
         new_node(NkRange, li(7, 16), @[
            new_inumber_node(NkIntLit, li(7, 17), 0, "0", Base10, -1),
            new_inumber_node(NkIntLit, li(7, 19), 0, "0", Base10, -1)
         ]),
   ...
   new_node(NkListOfPortDeclarations, li(1, 1), @[
      new_node(NkPortDecl, li(2, 4), @[
         ...
         new_node(NkVariablePort, li(3, 15), @[
            ...
            new_inumber_node(NkUIntLit, li(3, 24), 234, "EA", Base16, 8)
         ])
      ])
   ])
   ...
   new_node(NkListOfPortDeclarations, li(1, 1), @[
      new_node(NkPortDecl, li(2, 4), @[
         ...
         new_node(NkRange, li(2, 22), @[
            new_inumber_node(NkIntLit, li(2, 23), 7, "7", Base10, -1),
            new_inumber_node(NkIntLit, li(2, 25), 0, "0", Base10, -1)
         ]),
   ...
   new_node(NkListOfPortDeclarations, li(1, 1), @[
      new_node(NkPortDecl, li(2, 4), @[
         ...
         new_node(NkVariablePort, li(2, 19), @[
            ...
            new_inumber_node(NkIntLit, li(2, 27), 64, "64", Base10, -1)
         ]),
      ]),
      new_node(NkPortDecl, li(3, 4), @[
